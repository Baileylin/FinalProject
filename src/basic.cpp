...
//this method is used to implement the unique image
//color ray_color(const ray& r, const hittable_list& world, int depth)
//{
//   hit_record rec;
//   if (depth <= 0)
...
//
//    // World
//    shared_ptr<material> red = make_shared<lambertian>(color(1.0, 0.0, 0.0));
//    //shared_ptr<material> gray = make_shared<metal>(color(0.5f));
//
//    hittable_list world;
